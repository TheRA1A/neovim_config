...
-- Append 'alpha' to the 'nformats' option NOTE: for the incremental of the alphabets
	...
	{ "Bilal2453/luvit-meta", lazy = true },
	{
		...
		config = function()
			...
			local servers = {
				...
				-- pyright = {},
				-- verible = {
				-- 	cmd = { "verible-verilog-ls" }, -- Make sure Verible is installed and available in your PATH
				-- 	filetypes = { "verilog", "systemverilog" },
				-- 	root_dir = function(fname)
				-- 		return require("lspconfig.util").find_git_ancestor(fname) or vim.fn.getcwd()
				-- 	end,
				-- 	settings = {}, -- You can customize Verible settings here
				-- },
				verible = {
					cmd = { "verible-verilog-ls" }, -- Ensure Verible is installed and in your PATH
					filetypes = { "verilog", "systemverilog" },
					root_dir = function()
						-- Automatically use the current working directory as the project root
						return vim.fn.getcwd()
						-- Use Telescope's find_files logic to determine the root directory
					end,
					settings = {
						lint = {
				...
				-- 	filetypes = { "verilog", "systemverilog" },
				-- 	linters = {
				-- 		"svlint", -- Enable svlint for additional linting
				-- 	},
				-- },
	...
	-- Highlight todo, notes, etc in comments
	{
		...
		opts = {
			...
			keywords = {
				...
				TODO = { icon = " ", color = "info", alt = { "QUE", "QUESTION", "Class", "Module" } },
				HACK = { icon = " ", color = "warning" },
				WARN = { icon = " ", color = "warning", alt = { "WARNING", "XXX" } },
				PERF = { icon = " ", alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE" } },
				NOTE = { icon = " ", color = "hint", alt = { "INFO", "HINT" } },
				TEST = { icon = "⏲ ", color = "test", alt = { "TESTING", "PASSED", "FAILED" } },
				GROUP = { icon = "", color = "my_color", alt = { "Group" } },
				CONSTRUCTOR = { icon = "󱌣", color = "my_color", alt = { "Constructor" } },
				VAR = { icon = "󰫧", color = "my_color", alt = { "Var" } },
			},
			gui_style = {
...
require("command-completion").setup({
	...
	highlight_directories = true, -- Whether or not to highlight directories with
